...
EXPECTED_HASH = "2068874e4b9a9f0fb07ebe0ad2b29754449ccacd"

def download_cifar10_tiny():
    """下载 CIFAR-10 Tiny 数据集
    
    这是一个用于 Kaggle 竞赛的简化版 CIFAR-10 数据集。
    数据集包含训练集和测试集，用于图像分类任务。
    
    返回:
        数据集目录路径
    """
    dataset_dir = Path("dataset/cifar10_tiny")
    ...
    labels_file = dataset_dir / "trainLabels.csv"
...
if __name__ == "__main__":
    ...
    if data_dir:
        ...
        print(f"  - trainLabels.csv: {os.path.join(data_dir, 'trainLabels.csv')}")
